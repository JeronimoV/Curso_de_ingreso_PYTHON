...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert("Resultado", f"El resultado de la suma es: {result}")
    ...
    def btn_restar_on_click(self):
        ...
        alert("Resultado", f"El resultado de la resta es: {result}")
    ...
    def btn_multiplicar_on_click(self):
        ...
        alert("Resultado", f"El resultado de la multiplicacion es: {result}")
    ...
    def btn_dividir_on_click(self):
        ...
        alert("Resultado", f"El resultado de la division es: {result}")
